...
format: 
  revealjs:
    ...
    footer: "PS4168: Cillian McHugh - 31/10/25"
    theme: "resources/css/mytheme.scss"
    incremental: false
    chalkboard: 
      buttons: true
title-slide-attributes:
  data-background-image: "resources/images/halloween.png"
...
## Last week{.scrollable}

![](resources/images/mood_table2.png "Results"){.lightbox}

- Expected effects were not significant
- Three of the four cells were in the predicted direction
...
![](resources/images/travel_mug.jpeg "mugs"){.lightbox}


## Battery Pack


![](resources/images/powerbank.jpg "powerbank"){.lightbox width=400}
...
## Loss Aversion{.smallest}




![](resources/images/Screenshot_20180919_190001.png "value function"){.lightbox width=60%}
...
![](resources/images/golf.png "Golf"){.lightbox width=60%}
...
<iframe width="900" height="600" src="https://cillianmacaodh.shinyapps.io/week_8/" title="Shiny" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
![](resources/images/wtp_wta.png "WTPWTA"){.lightbox}
...
![](resources/images/travel_mug.jpeg "SupplyDemand"){.lightbox width=80%}
...
![](resources/images/powerbank.jpg "SupplyDemand"){.lightbox width=400}
...
![](resources/images/highlighters.jpeg "SupplyDemand"){.lightbox}
...
![](resources/images/supply_demand.png "SupplyDemand"){.lightbox}


## Hypotheses for the Current Studies{.smaller}
...
![](resources/images/end_fig2_1.png "Results"){.lightbox}
...
![](resources/images/table23a.png "Results"){.lightbox}


<font size=4.5>[@kahneman_experimental_1990]</font>


## Study 2 Results{.smallest}
...
![](resources/images/table23b.png "Results"){.lightbox}
...
<font size=5>$V/V$*~mugs~ = $2.5/9.5$ = $.26$</font>
...
<font size=5>$V/V$*~binoculars~ = $3.5/9.5$ = $.37$</font>
...
![](resources/images/table24a.png "Results"){.lightbox}
...
<font size=5>$V/V$*~induced~ = $5/6.5$ = $.77$</font>
...
<font size=5>$V/V$*~pen~ = $1.75/6.5$ = $.27$</font>
...
![](resources/images/table24b.png "Results"){.lightbox}
...
<font size=5>$V/V$*~induced~ = $15.5/18.5$ = $.82$</font>
...
<font size=5>$V/V$*~mug~ = $6/18.3$ = $.33$</font>
...
Identify any everyday “problem” and use your knowledge of the content covered in this module to develop a possible solution to this “problem”.

Create and record a short presentation (5-7 mins) outlining this solution.

Your presentation should:

- Clearly articulate the problem
- Provide a clear theoretical rationale for the proposed solution
- Clearly describe the proposed solution
- Describe how you would test the effectiveness of the solution

Your presentation should clearly address each of the points above; e.g., one suggestion could be to include a slide dedicated to each of the above points – with additional slides (e.g., introduction/conclusion) also permitted. A “references” slide is also recommended.
